...
\section{Virial expansion and Van der Waals gas} 
    ...
    \begin{proof}
        ...
        \end{equation*}
    \end{proof}
    Now, we have to solve this system of second degree by imposing an ansatz for $z(n)$
    \begin{equation*}
        z (n) = A n + B n^2 + O(n^3) ~,
    \end{equation*}
    ...
    \begin{figure}
        \centering
        \scalebox{0.7}{\pyc{plot1('x', 'x**(-12) - x**(-6)', 4, 1, 11, True, True, False)}}
